...
De las pruebas realizadas, se pudieron identificar segmentos de calles que cuentan con mayor información de tráfico a lo largo del día. La \Cref{fig:trafico_en_tr} muestra el estado del tráfico en tiempo real en una porción del mapa entre las 6 y 17 horas.
