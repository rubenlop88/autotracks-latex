...
\input{spanish_algorithmic}
\pgfplotsset{width=10cm,compat=1.9}

\usetikzlibrary{shapes.geometric, arrows, positioning}

% Definimos los componentes que usaremos para dibujar los diagramas
\tikzstyle{start}  = [rectangle, minimum width=2cm, minimum height=1cm, text badly centered, text width=2cm, draw=black, fill=white, inner sep=10pt, font=\footnotesize, rounded corners]
\tikzstyle{process} = [rectangle, minimum width=3cm, minimum height=1cm, text badly centered, text width=5cm, draw=black, fill=white, inner sep=10pt, font=\footnotesize]
\tikzstyle{decision} = [diamond, minimum width=3cm, minimum height=1cm, text badly centered, text width=3cm, draw=black, fill=white, font=\footnotesize, aspect=2]
\tikzstyle{arrow} = [thick, ->, >=stealth, font=\footnotesize]
